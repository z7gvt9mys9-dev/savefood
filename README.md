...
**[Презентация проекта](./SaveFood_Presentation.pptx)** · **[Полная архитектура](./ARCHITECTURE.md)** · **[Быстрый старт](#быстрый-старт-docker)** · **[API](#api)**
...
Без `YANDEX_MAPKIT_API_KEY` приложение собирается, но карты и подсказки адресов отключаются. Dev URL
