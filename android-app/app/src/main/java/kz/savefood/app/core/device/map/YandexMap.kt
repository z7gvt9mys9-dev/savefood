package kz.savefood.app.core.device.map
 ...
 * @param center initial camera focus. Falls back to the first marker, then Almaty.
...
private val ALMATY = Point(43.2389, 76.8897)
