...
public class AiService {
    ...
    private static final String SYSTEM_PROMPT = """
        ...
        - Нуждающийся регистрируется, загружает документ о статусе, модератор одобряет в течение 24 часов. Получать помощь можно не чаще раза в неделю. Одновременно может быть только одна активная заявка.
