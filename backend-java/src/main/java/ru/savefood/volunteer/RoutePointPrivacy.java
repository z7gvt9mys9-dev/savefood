...
public final class RoutePointPrivacy {
    ...
    /**
     * Ticket-point values needed only to locate/contact a recipient or understand
     * their private request. Aliases are included so legacy/future JSON shapes are
     * redacted even when they did not originate in the current Java writer.
     */
