...
class FoodCategoriesTest {
    ...
    /**
     * The routing scorer used to keep its own keyword table whose keys were
     * {@code молочные / выпечка / мясо / рыба / орехи}, matched by substring
     * against the lot category. Two of the four categories a shop can actually
     * publish therefore never matched anything, so those recipients' dietary
     * restrictions were silently ignored during selection.
     */
    @Test
